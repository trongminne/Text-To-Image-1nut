            ...
            with gr.Row(elem_classes='type_row'):
                ...
                with gr.Column(scale=17):
                  # Tạo Textbox Gradio
                    ...
                    prompt = gradio.Interface(prompt, parse_meta, inputs=[prompt, state_is_generating], outputs=[prompt, generate_button, load_parameter_button], queue=False, show_progress=False)
